...
const Mates = (() => {
  ...
  const MATES = [
    ...
    { id: 'legal', group: 'debut', icon: '⚡', name: 'Mat de Légal', en: "Légal's mate",
      ...
      fen: null,
      puzzles: [{ fen: 'rn1qkbnr/ppp2p1p/3p2p1/4p3/2B1P1b1/2N2N2/PPPP1PPP/R1BQK2R w KQkq - 0 5', sol: ['Nxe5', 'Bxd1', 'Bxf7+', 'Ke7', 'Nd5#'], hint: `Le clouage est un leurre. Prends e5 ! Si l'adversaire encaisse ta dame, mate avec le fou puis le cavalier.` }] },
  ...
  function renderMenu() {
    ...
    for (const grp of GROUPS) {
      html += `<div class="mate-group"><h4 class="mate-group-title">${grp.title}</h4>
