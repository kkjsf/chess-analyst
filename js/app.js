const App = (() => {
  ...
  function initPanels() {
    ...
    const panels = { guide: $('#panel-guide'), notation: $('#panel-notation'), concepts: $('#panel-concepts'), technical: $('#panel-technical') };
    const btns = { guide: $('#btn-guide'), notation: $('#btn-notation'), concepts: $('#btn-concepts'), technical: $('#btn-technical') };
  ...
  const CONCEPTS = (() => {
    ...
    return [
      ...
      { cat: '⚔️ Tactiques', name: 'Fourchette',
      ...
      { cat: '⚔️ Tactiques', name: 'Attaque double',
      ...
      { cat: '⚔️ Tactiques', name: 'Attaque / échec à la découverte',
      ...
      { cat: '⚔️ Tactiques', name: 'Déviation',
      ...
      { cat: '⚔️ Tactiques', name: 'Attraction',
      ...
      { cat: '⚔️ Tactiques', name: 'Surcharge',
      ...
      { cat: '♚ Mats classiques', name: 'Coup du Berger',
      ...
      { cat: '♚ Mats classiques', name: 'Mat du couloir',
      ...
      { cat: '♚ Mats classiques', name: "Mat de l'escalier",
      ...
      { cat: '♚ Mats classiques', name: 'Mat étouffé',
      ...
      { cat: '♚ Mats classiques', name: 'Mat de Légal',
      ...
      { cat: '♚ Mats classiques', name: 'Baiser de la mort',
      ...
      { cat: '♟ Concepts stratégiques', name: 'Pion passé',
      ...
      { cat: '♟ Concepts stratégiques', name: 'Pion isolé',
      ...
      { cat: '♟ Concepts stratégiques', name: 'Colonne ouverte & avant-poste',
      ...
      { cat: '♟ Concepts stratégiques', name: 'Paire de fous',
      ...
      { cat: '♟ Concepts stratégiques', name: 'Zugzwang',
      ...
      { cat: '♟ Concepts stratégiques', name: 'Initiative & tempo',
      ...
      { cat: '♟ Concepts stratégiques', name: 'Prophylaxie',
  ...
  function initConcepts() {
    ...
    for (const c of CONCEPTS) {
      ...
      const diagram = c.fen
        ...
        : '';
      html += `<div class="concept">${diagram}<div class="concept-body"><span class="concept-name">${c.name}</span><p>${c.desc}</p></div></div>`;
    }
    host.innerHTML = html;
  ...
  function openConceptModal(c) {
    ...
    $('#concept-modal-title').textContent = c.name;
