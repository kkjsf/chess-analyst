...
const Tactics = (() => {
  ...
  const CATALOG = [
    ...
    { cat: '⚔️ Tactiques', name: 'Enfilade', en: 'Skewer',
      desc: `L'inverse du clouage : on attaque une pièce de valeur qui, en s'écartant, <b>découvre une pièce moins précieuse</b> derrière elle. Ici l'échec sur la grande diagonale force le roi à bouger — et la tour tombe.`,
      fen: '6k1/8/8/4B3/8/8/1r6/6K1', arrows: [{ from: 'e5', to: 'g7', color: R }, { from: 'e5', to: 'b2', color: G }],
      puzzles: [
        { fen: '8/6k1/8/8/3B4/8/1r6/6K1 w - - 0 1', sol: ['Be5+', 'Kg8', 'Bxb2'], hint: 'Un échec du fou sur la grande diagonale : le roi s\'écarte, la tour reste exposée.' },
      ] },
    ...
    { cat: '⚔️ Tactiques', name: 'Attraction', en: 'Decoy',
      desc: `À l'inverse de la déviation, on <b>attire une pièce (souvent le roi) sur une case piégée</b>, généralement par un sacrifice, pour enchaîner avec une fourchette, un clouage ou un mat.`,
      fen: '6k1/5ppp/8/8/8/8/8/3R2K1', arrows: [{ from: 'd1', to: 'd8', color: B }] },
    ...
    { cat: '⚔️ Tactiques', name: 'Coup intermédiaire', en: 'Zwischenzug',
      ...
      fen: '6k1/5ppp/8/8/8/8/5PPP/4Q1K1', arrows: [{ from: 'e1', to: 'e8', color: R }] },
